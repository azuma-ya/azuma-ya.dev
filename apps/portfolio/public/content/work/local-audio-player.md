...
tags:
  - Next.js
description: ローカルファイルをWebで再生できる音声プレイヤー
...
- ローカルの音声ファイルを、アプリをインストールせずにブラウザ上で整理・再生したいユーザー
